...
const handlers = [
  rest.get("http://localhost:9001/api/todos", getAll),
  rest.get("http://localhost:9001/api/todos/:id", getById),
  rest.post("http://localhost:9001/api/todos", create),
  rest.patch("http://localhost:9001/api/todos/:id", toggleDone),
  rest.all("http://localhost:9001/*", catchAll),
];
